...
def scrape_and_caption_images(url:str, output_path:str="outputs/img_captions.txt"):
    """
    Scrape images from a webpage and generate captions for each image using BLIP model.
